class BS {
  ...
  get Bucket(): ReturnType<typeof $> {
    return $(
      'img[src="/static/media/delete-icon.98786469ba52bc63501716a59174d53c.svg"]',
    );
  }

  get ConfirmDeleting(): ReturnType<typeof $> {
    return $(
      'button[class="styles_btn__9DPcn styles_btnColorOrange__Jnd2G styles_btnStyleFilled__UVKdC styles_button__PuOil"]',
    );
  }
